...
#pragma warning restore 649
    ...
    public void StartGame(int categoryIndex,int temps)
    {
        gameScore = 0;
        lifesRemaining = 3;
        currentTime = temps;
    ...
    private void SelectQuestion()
    {
        /*        if (categoryIndexx == 0)
        {
            int vall = UnityEngine.Random.Range(0,1 );
            //set the selectedQuetion
            selectedQuetion = questions[vall];
            //send the question to quizGameUI
            quizGameUI.SetQuestion(selectedQuetion);

            questions.RemoveAt(vall);
            */
        //}
    ...
    public bool Answer(string selectedOption)
    {
        ...
        if (selectedQuetion.correctAns == selectedOption)
        {
            ...
            correct = true;
            gameScore += 50;
            quizGameUI.ScoreText.text = "Scoreee:" + gameScore;
        }
        else
        {
            gameScore -= 50;
